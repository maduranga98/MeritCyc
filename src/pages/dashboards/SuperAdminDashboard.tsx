  ...
  return (
    <div className="font-brand space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Here is a quick overview of your company's operations.</p>
      </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link
              ...
              className="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-lg hover:bg-slate-100 transition-colors"
            >
              <span className="font-semibold text-slate-800">Company Settings</span>
            </Link>
          </div>
        </div>
      </div>
